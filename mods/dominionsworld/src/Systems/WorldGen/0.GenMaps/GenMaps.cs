...
namespace dominions.world
{
    public class GenMaps : ModSystem
    {
        ...
        private void OnMapRegionGen(IMapRegion mapRegion, int regionX, int regionZ)
        {
            ...
            // Does not use the TerraGenConfig padding
            pad = 2;
            ...
            // plugging in our custom map
            mapRegion.ForestMap.Data = worldMap.GenForestLayer(
                regionX, regionZ,
                noiseSizeForest + 1, 
                noiseSizeForest + 1
                );
            ...
            // dominionsmod
            mapRegion.LandformMap.Data = worldMap.GenLandformLayer(
