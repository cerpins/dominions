...
namespace dominions.Systems
{
    ...
    public class BlockPatchConfig : WorldPropertyVariant
    {
        [JsonProperty]
        ...
        internal bool IsPatchSuitableAt(BlockPatch patch, Block onBlock, IWorldManagerAPI world, int climate, int y, float forestRel)
        {
            ...
            if ((patch.Placement == EnumBlockPatchPlacement.NearSeaWater || patch.Placement == EnumBlockPatchPlacement.NearSeaWater) && onBlock.LiquidCode != "saltwater") return false;
